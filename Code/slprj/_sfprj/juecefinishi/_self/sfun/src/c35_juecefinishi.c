...
static const char * c35_debug_family_names[10] = { "phi", "theta", "psi", "w_b",
  "W", "Euler", "nargin", "nargout", "u", "y" };

/* Function Declarations */
static void initialize_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
static void initialize_params_c35_juecefinishi(SFc35_juecefinishiInstanceStruct *
  chartInstance);
static void enable_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
static void disable_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
static void c35_update_debugger_state_c35_juecefinishi
  (SFc35_juecefinishiInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_juecefinishi
  (SFc35_juecefinishiInstanceStruct *chartInstance);
static void set_sim_state_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_st);
static void finalize_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
static void sf_gateway_c35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
static void initSimStructsc35_juecefinishi(SFc35_juecefinishiInstanceStruct
  *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct *chartInstance,
  const mxArray *c35_y, const char_T *c35_identifier, real_T c35_b_y[3]);
static void c35_b_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_c_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_c_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_d_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[9]);
...
static void c35_eml_scalar_eg(SFc35_juecefinishiInstanceStruct *chartInstance);
static void c35_eml_xgemm(SFc35_juecefinishiInstanceStruct *chartInstance,
...
static const mxArray *c35_d_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_e_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static uint8_T c35_f_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_b_is_active_c35_juecefinishi, const char_T *
  c35_identifier);
static uint8_T c35_g_emlrt_marshallIn(SFc35_juecefinishiInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_b_eml_xgemm(SFc35_juecefinishiInstanceStruct *chartInstance,
  real_T c35_A[9], real_T c35_B[3], real_T c35_C[3]);
static void init_dsm_address_info(SFc35_juecefinishiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_juecefinishi = 0U;
}
  ...
  (SFc35_juecefinishiInstanceStruct *chartInstance)
{
  ...
  real_T (*c35_d_y)[3];
  c35_d_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c35_st = NULL;
  c35_st = NULL;
  c35_y = NULL;
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_juecefinishi;
  ...
  *chartInstance, const mxArray *c35_st)
{
  ...
  int32_T c35_i1;
  real_T (*c35_y)[3];
  c35_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  chartInstance->c35_is_active_c35_juecefinishi = c35_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 1)),
     "is_active_c35_juecefinishi");
  sf_mex_destroy(&c35_u);
  c35_update_debugger_state_c35_juecefinishi(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T (*c35_j_y)[3];
  real_T (*c35_b_u)[3];
  c35_j_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c35_b_u = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 30U, chartInstance->c35_sfEvent);
  for (c35_i2 = 0; c35_i2 < 3; c35_i2++) {
    _SFD_DATA_RANGE_CHECK((*c35_b_u)[c35_i2], 0U);
  }

  chartInstance->c35_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 30U, chartInstance->c35_sfEvent);
  for (c35_i3 = 0; c35_i3 < 3; c35_i3++) {
    c35_u[c35_i3] = (*c35_b_u)[c35_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c35_debug_family_names,
    c35_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c35_phi, 0U, c35_b_sf_marshallOut,
    c35_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c35_theta, 1U, c35_b_sf_marshallOut,
    c35_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c35_psi, 2U, c35_b_sf_marshallOut,
    c35_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c35_w_b, 3U, c35_sf_marshallOut,
    c35_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c35_W, 4U, c35_c_sf_marshallOut,
    c35_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c35_Euler, 5U, c35_sf_marshallOut,
    c35_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c35_nargin, 6U, c35_b_sf_marshallOut,
    c35_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c35_nargout, 7U, c35_b_sf_marshallOut,
    c35_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c35_u, 8U, c35_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c35_y, 9U, c35_sf_marshallOut,
    c35_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c35_i4 = 0; c35_i4 < 3; c35_i4++) {
    c35_w_b[c35_i4] = c35_u[c35_i4];
  }

  _SFD_EML_CALL(0U, chartInstance->c35_sfEvent, 14);
  c35_x = c35_theta;
  c35_b_x = c35_x;
  c35_b_x = muDoubleScalarTan(c35_b_x);
  c35_c_x = c35_phi;
  c35_d_x = c35_c_x;
  c35_d_x = muDoubleScalarSin(c35_d_x);
  c35_e_x = c35_theta;
  c35_f_x = c35_e_x;
  c35_f_x = muDoubleScalarTan(c35_f_x);
  c35_g_x = c35_phi;
  c35_h_x = c35_g_x;
  c35_h_x = muDoubleScalarCos(c35_h_x);
  c35_i_x = c35_phi;
  c35_j_x = c35_i_x;
  c35_j_x = muDoubleScalarCos(c35_j_x);
  c35_k_x = c35_phi;
  c35_l_x = c35_k_x;
  c35_l_x = muDoubleScalarSin(c35_l_x);
  c35_m_x = c35_phi;
  c35_n_x = c35_m_x;
  ...
  c35_s_x = c35_r_x;
  c35_d_y = c35_c_y;
  c35_e_y = c35_s_x / c35_d_y;
  c35_t_x = c35_phi;
  c35_u_x = c35_t_x;
  c35_u_x = muDoubleScalarCos(c35_u_x);
  c35_v_x = c35_theta;
  c35_w_x = c35_v_x;
  c35_w_x = muDoubleScalarCos(c35_w_x);
  c35_b_A = c35_u_x;
  c35_b_B = c35_w_x;
  c35_x_x = c35_b_A;
  c35_f_y = c35_b_B;
  ...
  c35_ab_x = c35_y_x;
  c35_h_y = c35_g_y;
  c35_i_y = c35_ab_x / c35_h_y;
  c35_W[0] = 1.0;
  c35_W[3] = c35_b_x * c35_d_x;
  c35_W[6] = c35_f_x * c35_h_x;
  c35_W[1] = 0.0;
  c35_W[4] = c35_j_x;
  c35_W[7] = -c35_l_x;
  c35_W[2] = 0.0;
  ...
  c35_b_eml_xgemm(chartInstance, c35_dv3, c35_dv4, c35_Euler);
  _SFD_EML_CALL(0U, chartInstance->c35_sfEvent, 20);
  for (c35_i13 = 0; c35_i13 < 3; c35_i13++) {
    c35_y[c35_i13] = c35_Euler[c35_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c35_sfEvent, -20);
  _SFD_SYMBOL_SCOPE_POP();
  for (c35_i14 = 0; c35_i14 < 3; c35_i14++) {
    (*c35_j_y)[c35_i14] = c35_y[c35_i14];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 30U, chartInstance->c35_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_juecefinishiMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c35_i15 = 0; c35_i15 < 3; c35_i15++) {
    _SFD_DATA_RANGE_CHECK((*c35_j_y)[c35_i15], 1U);
  }
}
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_juecefinishiInstanceStruct *chartInstance;
  chartInstance = (SFc35_juecefinishiInstanceStruct *)chartInstanceVoid;
  ...
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData)
{
  ...
  for (c35_i19 = 0; c35_i19 < 3; c35_i19++) {
    (*(real_T (*)[3])c35_outData)[c35_i19] = c35_b_y[c35_i19];
  }
  ...
  real_T c35_y[9])
{
  ...
  int32_T c35_i26;
  (void)chartInstance;
  sf_mex_import(c35_parentId, sf_mex_dup(c35_u), c35_dv6, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c35_i26 = 0; c35_i26 < 9; c35_i26++) {
    c35_y[c35_i26] = c35_dv6[c35_i26];
  }
  ...
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData)
{
  ...
  SFc35_juecefinishiInstanceStruct *chartInstance;
  chartInstance = (SFc35_juecefinishiInstanceStruct *)chartInstanceVoid;
  c35_W = sf_mex_dup(c35_mxArrayInData);
  c35_identifier = c35_varName;
  c35_thisId.fIdentifier = c35_identifier;
  c35_thisId.fParent = NULL;
  c35_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c35_W), &c35_thisId, c35_y);
  sf_mex_destroy(&c35_W);
  c35_i27 = 0;
...
const mxArray *sf_c35_juecefinishi_get_eml_resolved_functions_info(void)
{
  const mxArray *c35_nameCaptureInfo = NULL;
  c35_nameCaptureInfo = NULL;
  sf_mex_assign(&c35_nameCaptureInfo, sf_mex_createstruct("structure", 2, 26, 1),
                false);
...
static void c35_info_helper(const mxArray **c35_info)
{
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("tan"), "name", "name", 0);
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/tan.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1343837586U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/tan.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("eml_scalar_tan"), "name",
                  "name", 1);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_tan.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1286825938U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1286825936U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("cos"), "name", "name", 4);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 4);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1343837572U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1286825922U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, sf_mex_duplicatearraysafe(&c35_lhs5), "lhs", "lhs",
                  5);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(""), "context", "context", 6);
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 8);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("rdivide"), "name", "name", 8);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c35_info, sf_mex_duplicatearraysafe(&c35_lhs12), "lhs", "lhs",
                  12);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(""), "context", "context", 13);
  ...
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1383880894U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1375987890U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1389311522U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p!below_threshold"),
                  "context", "context", 22);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "coder.internal.blas.threshold"), "name", "name", 22);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1381857500U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p"),
                  "context", "context", 25);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "coder.internal.refblas.xgemm"), "name", "name", 25);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
  ...
  c35_identifier)
{
  ...
  c35_y = c35_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c35_b_is_active_c35_juecefinishi), &c35_thisId);
  sf_mex_destroy(&c35_b_is_active_c35_juecefinishi);
  return c35_y;
}
...
void sf_c35_juecefinishi_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2593939134U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2182195979U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(454606966U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1916768708U);
}

mxArray *sf_c35_juecefinishi_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kFNn8RCEBIrg1lJRxnn1lH");
...
mxArray *sf_c35_juecefinishi_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_juecefinishi_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c35_juecefinishi(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c35_juecefinishi\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_juecefinishi_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_juecefinishiInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c35_y)[3];
          c35_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c35_u = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c35_u);
...
{
  return "defwvx6BZYJMMTLEslQiAB";
}

static void sf_opaque_initialize_c35_juecefinishi(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_juecefinishiInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
    chartInstanceVar);
  initialize_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_juecefinishi(void *chartInstanceVar)
{
  enable_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c35_juecefinishi(void *chartInstanceVar)
{
  disable_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c35_juecefinishi(void *chartInstanceVar)
{
  sf_gateway_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c35_juecefinishi(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c35_juecefinishi
    ((SFc35_juecefinishiInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c35_juecefinishi();/* state var info */
...
extern void sf_internal_set_sim_state_c35_juecefinishi(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c35_juecefinishi();/* state var info */
  ...
  set_sim_state_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c35_juecefinishi(SimStruct* S)
{
  return sf_internal_get_sim_state_c35_juecefinishi(S);
}

static void sf_opaque_set_sim_state_c35_juecefinishi(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c35_juecefinishi(S, st);
}

static void sf_opaque_terminate_c35_juecefinishi(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_juecefinishiInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_juecefinishi((SFc35_juecefinishiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_juecefinishi(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_juecefinishi(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3015055150U));
  ssSetChecksum1(S,(3105423432U));
  ssSetChecksum2(S,(571585375U));
  ssSetChecksum3(S,(3831485967U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c35_juecefinishi(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_juecefinishi(SimStruct *S)
{
  SFc35_juecefinishiInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_juecefinishiInstanceStruct *)utMalloc(sizeof
    (SFc35_juecefinishiInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_juecefinishiInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c35_juecefinishi;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_juecefinishi;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c35_juecefinishi;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_juecefinishi;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_juecefinishi;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_juecefinishi;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_juecefinishi;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_juecefinishi;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_juecefinishi;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_juecefinishi;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c35_juecefinishi;
...
void c35_juecefinishi_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_juecefinishi(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_juecefinishi(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_juecefinishi(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_juecefinishi_method_dispatcher.\n"
